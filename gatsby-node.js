...
exports.sourceNodes = async ({
  ...
  const attachments = getImageAttachments(entities); // we need to await transforming all the entities since we may need to get images remotely and generating fluid image data is async
